# This program gets a series of test scores and calculates the average of the scores with the
...
# The get_total function accepts a list as an argument returns the total of the values in 
# the list.
